...
public class Artist {
	...
	//Draws a quad with a given texture to the display after rotating it on an angle
	public static void DrawQuadTexRot(float x, float y, float width, float height, float angle, Texture tex) {
		tex.bind();
	...
	//Draws a quad texture to the display
